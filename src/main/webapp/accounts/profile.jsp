...
<head>
    ...
    <style>
        <%@include file="../resources/css/accounts/profile.css" %>
    </style>
</head>
<body>
...
<form id="Details" method="post" class="details">
    <div class="detail-box">
        ...
        <p><%= sessionUser.getName() %>
        </p>

        <br/>
        <label>Your Date of Birth : </label>
        <p><%= sessionUser.getDob() %>
        </p>

        <br/>
        <label>Your Email ID : </label>
        <p><%= sessionUser.getEmail() %>
        </p>

        <br/>
        <label>Your Phone Number :</label>
        <p><%= sessionUser.getPhonenumber() %>
        </p>

        <br/>
        <label>Your Username :</label>
        <p><%= sessionUser.getUsername() %>
        </p>

        <br/>
        <label>Your Address :</label>
        <p><%= sessionUser.getAddress() %>
        </p>

        <br/>
        <label>Your Wallet Amount : </label>
        <p><%= sessionUser.getWallet() %>
        </p>
