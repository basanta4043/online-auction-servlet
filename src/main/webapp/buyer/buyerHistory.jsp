<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8" %>
<%@page import="com.onlineauction.onlineauctionservlet.model.beans.Product" %>
...
<head>
    ...
    <style>
        <%@include file="../resources/css/seller/SellerPage.css" %>
    </style>
    <style>
...
<div class="container">
    <div id="productsContainer" class="grid-row">
        ...
        <div class="card">
            ...
            <p><span style="font-weight:bold">Price:</span>&nbsp;Rs. <%=product.getProductPrice() %>
            </p>
            <p><span style="font-weight:bold">Category:</span> <%=product.getProductCategory() %>
            </p>
            <p><span style="font-weight:bold">Quantity:</span> <%=product.getProductQuantity() %>
            </p>
            <p><span style="font-weight:bold">Seller ID:</span><%=product.getProductSellerId()%>
            </p>
            <br/>
        </div>
        <%} %>
