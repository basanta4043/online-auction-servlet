...
<head>
    ...
    <style>
        <%@include file="../resources/css/accounts/registration.css" %>
    </style>
...
<div class="text-center">
    ...
    <h3>Create your Online Auction account</h3>
</div>
<br/>
    ...
    <div class="form-container">
        <form id="userRegisterForm" method="post">
            <div class="register-box">
                ...
                <div class="form-group">
                    <label for="userType">How do you want to use Online Auction System? <span
...
<script>
    <%@include file="../resources/js/utility/inputValidation.js" %>
</script>
<script>
    <%@include file="../resources/js/accounts/register.js" %>
</script>
